...
public class ImageTest {
    ...
    public void create_image() {
        assertThatNoException().isThrownBy(() -> new Image(1000L, ImageType.GIF, 300L, 200L));
    }

    @DisplayName("크기가 1MB 초과인 이미지는 생성할 수 없습니다.")
    @Test
    public void create_image_over_1MB() {
        assertThatThrownBy(() -> new Image(1001L, ImageType.GIF, 300L, 200L))
    ...
    public void create_image_below_width_height() {
        assertThatThrownBy(() -> new Image(1000L, ImageType.GIF, 297L, 198L))
                .isInstanceOf(CannotUploadImageException.class)
    ...
    public void create_image_width_height_ratio() {
        assertThatThrownBy(() -> new Image(1000L, ImageType.GIF, 300L, 205L))
                .isInstanceOf(CannotUploadImageException.class)
