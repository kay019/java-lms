...
public class RegisterTest {
    ...
    public void register_session_out_recruiting() {
        assertThatThrownBy(() -> Register.registerSession(NsUserTest.JAVAJIGI,
                0L,
                new NaturalNumber(1000L),
                SessionState.PREPARING,
                new FreePayStrategy(),
                Arrays.asList(
                        new NsStudent(NsUserTest.SANJIGI, 0L)
                )))
    ...
    public void register_free_session() {
        assertThatNoException().isThrownBy(() -> Register.registerSession(NsUserTest.JAVAJIGI,
                0L,
                new NaturalNumber(1000L),
                SessionState.RECRUTING,
                new FreePayStrategy(),
