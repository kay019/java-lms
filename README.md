...
- [ ] 과정은 기수 단위로 운영됩니다. -> nextstep에서는 각 기수가 세션으로 관리됨
- [ ] 하나의 과정은 여러 개의 강의(Session)를 포함할 수 있습니다.
- [x] 각 강의는 시작일과 종료일 정보를 가집니다.

---

### 🖼️ 강의 이미지 요구사항
- [ ] 모든 강의는 커버 이미지 정보를 가집니다.
- 이미지 제약 조건:
  - [ ] 최대 크기: **1MB 이하**
  - [ ] 지원 형식: **gif, jpg(jpeg), png, svg**
  - [ ] 최소 해상도: **너비 300픽셀, 높이 200픽셀 이상**
  - [ ] 비율: **너비:높이 = 3:2**

---

### 💡 강의 유형 및 수강 제한
- [ ] 강의는 **무료** 또는 **유료**로 구분됩니다.
- **무료 강의**:
  - [ ] 수강 인원 제한 없음
- **유료 강의**:
  - [ ] 최대 수강 인원을 초과할 수 없음
  - [ ] 수강생 결제 금액과 강의 수강료가 **일치해야** 수강 신청 가능
...
- [ ] 결제 정보는 외부 `payments` 모듈에서 관리됩니다.
- [ ] 결제 정보는 `Payment` 객체 형태로 제공됩니다.
